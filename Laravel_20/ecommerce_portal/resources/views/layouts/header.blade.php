            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <nav class="hidden lg:flex space-x-8">
                        ...
                        <!-- Reguar Menu Items  -->
                        <a href="{{url('category/electronics')}}" class="text-gray-700 hover:text-indigo-600 font-medium transition">About Us</a>
                        ...
                        <a href="{{url('category/electronics/tv')}}" class="text-gray-700 hover:text-indigo-600 font-medium transition">Category</a>
                    </nav>
                    <!-- Auth Buttons -->
