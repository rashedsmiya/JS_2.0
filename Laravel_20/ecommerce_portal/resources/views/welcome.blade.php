...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="{{asset('https://laravel.com/assets/img/welcome/background.svg')}}" alt="Laravel background" />
                            ...
                            <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                <img
                                    ...
                                    onerror="
                                        ...
                                        " />
                                <img
                                    src="{{asset('https://laravel.com/assets/img/welcome/docs-dark.svg')}}"
                                    alt="Laravel documentation screenshot"
