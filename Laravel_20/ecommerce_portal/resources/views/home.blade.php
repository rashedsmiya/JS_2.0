...
<body class="bg-gray-50">
    ...
    <section class="relative h-[80vh] overflow-hidden">
        <div class="absolute inset-0">
            <img src="https://carrent.aanwebsolutions.com/demo/imgs/car5.webp" alt="Mercedes S-Class"
                ...
                <div class="lg:col-span-2 space-y-12">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            <img src="https://carrent.aanwebsolutions.com/demo/imgs/car5.webp"
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="border-b border-gray-200 pb-8">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        <img src="https://carrent.aanwebsolutions.com/demo/imgs/profile1.jpeg"
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-4">
                                        <img src="https://carrent.aanwebsolutions.com/demo/imgs/profile2.jpeg"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden group hover:shadow-xl transition duration-300 car-card"
                    ...
                    <div class="relative">
                        <img src="https://carrent.aanwebsolutions.com/demo/imgs/car1.jpeg" alt="Mercedes S-Class"
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden group hover:shadow-xl transition duration-300 car-card"
                    data-category="suv">
                    <div class="relative">
                        <img src="https://carrent.aanwebsolutions.com/demo/imgs/car2.jpeg" alt="Range Rover Sport"
                            class="w-full h-48 object-cover group-hover:scale-105 transition duration-500">
                        <div
                            class="absolute top-4 right-4 bg-indigo-600 text-white text-sm font-medium px-3 py-1 rounded-full">
                            Available Now
                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden group hover:shadow-xl transition duration-300 car-card"
                    ...
                    <div class="relative">
                        <img src="https://carrent.aanwebsolutions.com/demo/imgs/car3.jpeg" alt="Porsche 911"
                            class="w-full h-48 object-cover group-hover:scale-105 transition duration-500">
                        <div
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <span class="text-xl font-bold">MyCarRental</span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Our Fleet</a></li>
            ...
            <div class="border-t border-gray-800 pt-8">
                <p class="text-center text-gray-400">
                    © 2025 MyCarRental. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
